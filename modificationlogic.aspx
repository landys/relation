<%@ Page Language="vb" AutoEventWireup="false" Codebehind="modificationlogic.aspx.vb" Inherits="relation.modificationlogic"%>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>modificationlogic</title>
							...
							<TR>
								...
								<TD class="p9" vAlign="middle" width="548" background="imga/blue2.jpg" bgColor="#00459c"
									...
									<DIV align="left"><SPAN class="p10"><FONT color="#ffffff"><A class="whitemenu" onmouseover="showMenu(this,'topmenu1',0)" onmouseout="hideMenu(event)"
													...
													href="rmodelsearch.aspx" target="_top">查询</A>&nbsp;<A href="rmodelmodification.aspx" target="_top">修改</A>
											</FONT></SPAN>
									</DIV>
								</TD>
							</TR>
															...
															<TABLE id="Table15" style="WIDTH: 153px; HEIGHT: 153px" width="153" border="1">
																<TR>
																	<TD width="147" height="45">
																		<DIV align="center">&nbsp;<A href="rmodelsearch.aspx">修改关系空间</A></DIV>
																	</TD>
																</TR>
																<TR>
																	<TD height="43">
																		<DIV align="center"><A href="rdefinitionsearch.aspx">修改关系类型</A></DIV>
																	</TD>
																</TR>
																<TR>
																	<TD height="55">
																		<DIV align="center"><A href="rinstancesearch.aspx">修改关系实例</A></DIV>
																	</TD>
																</TR>
															</TABLE>
															<BR>
						...
						<TR>
							<TD>
								<TABLE id="Table2" style="WIDTH: 544px; HEIGHT: 158px" cellSpacing="1" cellPadding="1"
									...
									<TR>
										<TD>
											<asp:Label id="lblLogKey" runat="server">关系间逻辑编号</asp:Label></TD>
									</TR>
									<TR>
										<TD>
											<asp:DropDownList id="ddlstLogKey" runat="server"></asp:DropDownList>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
											&nbsp;
											<asp:Button id="btnSearch" runat="server" Text="搜索"></asp:Button></TD>
									</TR>
									<TR>
										<TD>
											<asp:Label id="lblDefFrom" runat="server">第一条关联关系</asp:Label></TD>
									</TR>
									<TR>
										<TD>
											<asp:DropDownList id="ddlstDefFrom" runat="server" Width="152px"></asp:DropDownList></TD>
									</TR>
									<TR>
										<TD>
											<asp:Label id="lblDefTo" runat="server">第二条关联关系</asp:Label></TD>
									</TR>
									<TR>
										<TD>
											<asp:DropDownList id="ddlstDefTo" runat="server" Width="148px"></asp:DropDownList></TD>
									</TR>
									<TR>
								...
								<asp:label id="lblWarning" runat="server" Width="532px" ForeColor="#0000C0" Height="14px">label</asp:label>
							</TD>
						</TR>
