<%@ Page Language="vb" AutoEventWireup="false" Codebehind="to1.aspx.vb" Inherits="relation.to1"%>
			...
			<TR>
				...
				<TD class="p9" vAlign="middle" width="548" background="imga/blue2.jpg" bgColor="#00459c"
					...
					<DIV align="left"><SPAN class="p10"><FONT color="#ffffff"><A class="whitemenu" onmouseover="showMenu(this,'topmenu1',0)" onmouseout="hideMenu(event)"
									href="to1.aspx" target="_top">发布</A> <A class="whitemenu" onmouseover="showMenu(this,'topmenu2',0)" onmouseout="hideMenu(event)"
									href="to.aspx" target="_top">查询</A>&nbsp;修改 </FONT></SPAN>
					</DIV>
				</TD>
			</TR>
		</TABLE>
		...
		<TABLE id="Table11" height="62" cellSpacing="0" width="778" align="center">
			<TR border="0">
				<TD class="p10" vAlign="top" background="imga/bg3.gif" colSpan="2" height="20" border="0"><IMG height="1" src="imga/03.gif" width="100%"><BR>
					<FONT color="#000000">&nbsp;|</FONT><FONT color="#000000"><SPAN class="p9"> 首页</SPAN>
					</FONT><FONT color="#000000">|</FONT> <FONT color="#000000"><SPAN class="p9">用户登录</SPAN>
						|注册 </FONT>
				</TD>
			</TR>
			<TR border="0">
				<TD vAlign="top" width="172" bgColor="#0859ad" height="20">&nbsp;</TD>
				<TD vAlign="top" bgColor="#0859ad" height="20">
					<DIV align="right"><FONT color="#ffffff">欢迎您 &nbsp;软件业的朋友！ &nbsp; &nbsp;</FONT></DIV>
				</TD>
			</TR>
		</TABLE>
		<CENTER>
										...
										<TABLE id="Table15" style="WIDTH: 153px; HEIGHT: 153px" width="153" border="1">
											<TR>
												<TD width="147" height="45">
													<DIV align="center">&nbsp;&nbsp;发布关系空间</DIV>
												</TD>
											</TR>
											<TR>
												<TD height="43">
													<DIV align="center">发布关系类型</DIV>
												</TD>
											</TR>
											<TR>
												<TD height="55">
													<DIV align="center">发布关系实例</DIV>
												</TD>
											</TR>
										</TABLE>
										<BR>
